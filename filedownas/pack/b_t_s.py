...
class BaiDuPan(object):
    def __init__(self):
        ...
        self.session.cookies['BDUSS'] ='UpHY2tkVDVlazItUkp4aE51VWM0SHZqMEtGbmtxaURBWlZxNmZMZDVrTG9xWVZlRVFBQUFBJCQAAAAAAAAAAAEAAAA11Pg1sK7S8su5zLmw1gAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAOgcXl7oHF5eV'
        self.session.cookies['STOKEN'] = 'b297137dd6ebd949e0072b59a5104ef2045bcdabab6e0dcd8c52e7494dfeffc8'
        #self.session.cookies['BDUSS'] = 'p2SW5VYmwtMFluMHRJNkt6cEtSc21LTUZaRWlvd3VzTnBQeHR-Tmp5SHRtSVZlRVFBQUFBJCQAAAAAAAAAAAEAAACnqKsdZGxvZWNxaTQyMjM0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAO0LXl7tC15eUW'
        #self.session.cookies['STOKEN'] = '34cf9b7223d3f098697efa0cf3dbcc3603ab61627c225110e6e02c874996a316'
        self.headers = {
            'Host': 'pan.baidu.com',
    ...
    def saveShare(self, url, pwd, path):
